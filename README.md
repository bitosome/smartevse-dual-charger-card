...
- Hero pills follow a fixed priority—active plan, live controller state, active limits, standing plan, standing limits—and prefix timer and price values with their owning plan.
